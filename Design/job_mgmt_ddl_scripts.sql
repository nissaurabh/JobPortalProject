...
CREATE TABLE `job` (
  ...
  KEY `job_cndt_ref_nm_idx` (`cndt_id`),
  ...
  CONSTRAINT `job_cndt_ref_nm1` FOREIGN KEY (`cndt_id`) REFERENCES `job_cndt` (`cndt_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `job_sts_ref_nm1` FOREIGN KEY (`job_sts_id`) REFERENCES `job_sts` (`job_sts_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `empt_typ_ref_nm1` FOREIGN KEY (`empt_typ_id`) REFERENCES `empt_typ` (`empt_typ_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `job_role` (
  ...
  UNIQUE KEY `job_rl_nm_UNIQUE` (`job_rl_nm`),
...
CREATE TABLE `service_ln_cap` (
  ...
  UNIQUE KEY `srvc_ln_cap_nm_UNIQUE` (`srvc_ln_cap_nm`),
